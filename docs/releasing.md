...
The source is available on [GitHub](https://github.com/christypixel68-cloud/mdlink-audit) as an initial 0.1.0 implementation. The package has not been published to PyPI. Use this checklist to verify a candidate before creating a versioned release or publishing distribution artifacts.
